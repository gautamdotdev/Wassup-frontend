...
export const THEMES: ThemeDef[] = [
  ...
  },
  {
    ...
    label: "Cherry",
    chatBg:
      "linear-gradient(160deg, #140008 0%, #2b0015 40%, #1a000d 70%, #140008 100%)",
    hex: "#140008",
    headerBg: "linear-gradient(135deg, #1a000d 0%, #3b001f 100%)",
    bottomBg:
      "linear-gradient(to top, #140008 0%, #2b001580 60%, transparent 100%)",
    msgMenuBg: "rgba(30,0,15,0.95)",
    msgMenuBorder: "rgba(251,113,133,0.25)",
    myBubble: "linear-gradient(135deg, #e11d48 0%, #fb7185 100%)",
    myBubbleText: "#ffffff",
    otherBubble: "rgba(60, 0, 25, 0.6)",
